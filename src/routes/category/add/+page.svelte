<!-- src/routes/category/add/+page.svelte -->
<script>
    ...
    // Form state - initialize dengan nilai default untuk form tambah
    let category = {
        name: '',
        isActive: true
    };
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (error.errors && Object.keys(error.errors).length > 0) {
                ...
                showErrorNotification(error.message || 'Gagal menambahkan kategori');
            }
        } finally {
            isSaving = false;
        }
...
<svelte:head>
    <title>Tambah Kategori - CMS Admin</title>
</svelte:head>
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-green-800">
                        Kategori berhasil ditambahkan! Mengalihkan ke halaman kategori...
                    </p>
                </div>
            </div>
        </div>
